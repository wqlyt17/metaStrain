...
do
	...
	g++ -O2 -o ${path1}/assembly_select ${path1}/Assembly_summary_select.cc
	g++ -O2 -o ${path1}/extract_genome ${path1}/Extract_genome_sequences.cc
	g++ -O2 -o ${path1}/extract_cds ${path1}/Extract_cds_sequences.cc
