...
do
	...
	$path_code/upadd centroid.txt mus_reduced.txt UP_reduced.fa UP_location_reduced.txt 0.$c
	...
	./a.out centroid.txt pseudo_gene_arrangements.txt Com_supple.fa Com_location_supple.txt
	
	##intraspecies filtering
	minimap2 -ax asm5 $path_1/$input_3 Com_supple.fa > Com_reference.sam
	...
	./a.out centroid.txt pseudo_gene_arrangements_reduced.txt Com_supple.fa Com_location_supple.txt 0.$c 
